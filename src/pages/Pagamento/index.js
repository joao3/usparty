            ...
            <div className='radioPagamento'>
              ...
              <label htmlFor='pix' className='box first'>
                <div className='metodoText'>
                  ...
                  <img src='https://logospng.org/download/pix/logo-pix-icone-256.png' style={{ "maxHeight": "20px", "marginRight": "16px" }}></img>
              ...
              <label htmlFor='boleto' className='box second'>
                <div className='metodoText'>
                  <span className="circle"></span>
                  <img src='https://cdn-icons-png.flaticon.com/512/25/25350.png' style={{ "maxHeight": "20px", "marginRight": "16px" }}></img>
              ...
              <label htmlFor='cartao' className='box third'>
                <div className='metodoText'>
                  <span className="circle"></span>
                  <img src='https://cdn.icon-icons.com/icons2/510/PNG/512/card_icon-icons.com_50439.png' style={{ "maxHeight": "20px", "marginRight": "16px" }}></img>
