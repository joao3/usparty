    ...
    <div className="ItemNoCarrinho">
      ...
      <div className='info'>
        ...
        <div className='quantidade'>
          ...
          <input onChange={e => handleInputNumber(e.target.valueAsNumber)} type="number" min={1} value={inputNumber} style={{ "width": "55px" }}></input>
        </div>


        <div className='removerCarrinho' onClick={() => props.remover(props.evento)}>
          Remover do carrinho
        </div>
